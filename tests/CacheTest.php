...
class CacheTest extends TestCase
{
    ...
    {
        $driver = 'custom';
        $callback = fn(): string => 'custom_driver';
    ...
    public function testHasUsesDriverHasMethodWhenAvailable(): void
    {
        ...
        $mockDriverWithHas = new class implements CacheInterface {
            ...
            public function tags(array $tags): TaggedCache { return new TaggedCache(new ArrayStore(), $tags); }
    ...
    public function testKeyHandlesArrayComponents(): void
    {
        ...
        $expected = sprintf('users:%s:list', $expectedHash);
