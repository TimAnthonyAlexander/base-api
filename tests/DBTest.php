...
class DBTest extends TestCase
{
    ...
    public function testQbReturnsQueryBuilder()
    {
        $qb = $this->db->qb();
    ...
    public function testQbReturnsNewInstanceEachTime()
    {
        $qb1 = $this->db->qb();
        $qb2 = $this->db->qb();
    ...
    public function testPdoReturnsConnectionPdo()
    {
        $pdo = $this->db->pdo();
    ...
    public function testRawQueryExecution()
    {
    ...
    public function testRawQueryWithoutBindings()
    {
    ...
    public function testRawQueryThrowsDbExceptionOnPdoException()
    {
        $sql = 'INVALID SQL';
    ...
    public function testScalarQueryExecution()
    {
    ...
    public function testScalarQueryWithBindings()
    {
    ...
    public function testScalarQueryThrowsDbExceptionOnPdoException()
    {
        $sql = 'INVALID SQL';
        $pdoException = new \PDOException('Syntax error');
    ...
    public function testExecQueryExecution()
    {
    ...
    public function testExecQueryWithoutBindings()
    {
    ...
    public function testExecQueryThrowsDbExceptionOnPdoException()
    {
        $sql = 'INVALID SQL';
        $pdoException = new \PDOException('Syntax error');
    ...
    public function testQueryLoggingWhenAppExists()
    {
    ...
    public function testQueryLoggingHandlesExceptions()
    {
        $sql = 'SELECT * FROM users';
        $expectedResult = [['id' => '1']];
    ...
    public function testMultipleConsecutiveQueries()
    {
    ...
    public function testQueryWithComplexBindings()
    {
    ...
    public function testEmptyResultHandling()
    {
        $sql = 'SELECT * FROM users WHERE id = ?';
    ...
    public function testScalarNullResult()
    {
    ...
    public function testExecZeroRowsAffected()
    {
        $sql = 'UPDATE users SET name = ? WHERE id = ?';
