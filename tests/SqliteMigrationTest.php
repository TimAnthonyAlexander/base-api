...
class SqliteMigrationTest extends TestCase
{
    ...
    /**
     * Test that adding NOT NULL columns without defaults gets auto-generated defaults
     */
    public function testAddColumnWithAutoGeneratedDefaults(): void
    {
        $driver = new SqliteDriver();
        
        $plan = new MigrationPlan();
        
        // Add a REAL column without default (like float $discount;)
        ...
        // Add a TEXT column without default
        $plan->addOperation('add_column', [
            'table' => 'offers', 
            'column' => [
                'name' => 'category',
        ...
        // Add an INTEGER column without default
        $plan->addOperation('add_column', [
            'table' => 'offers',
            'column' => [
                'name' => 'priority',
    ...
    /**
     * Test that nullable columns don't get auto-generated defaults
     */
    public function testAddNullableColumnNoAutoDefault(): void
    {
        $driver = new SqliteDriver();
        ...
        $sql = $statements[0]['sql'];
        $this->assertStringContainsString('ALTER TABLE "offers" ADD COLUMN "optional_field" TEXT', $sql);
        $this->assertStringNotContainsString('DEFAULT', $sql);
        $this->assertStringNotContainsString('NOT NULL', $sql);
        $this->assertNull($statements[0]['warning']);
    }
    
    /**
     * Test that columns with explicit defaults don't get auto-generated ones
     */
    public function testAddColumnWithExplicitDefaultNoAutoDefault(): void
    {
        $driver = new SqliteDriver();
        ...
        $sql = $statements[0]['sql'];
        $this->assertStringContainsString('ALTER TABLE "offers" ADD COLUMN "status" TEXT NOT NULL DEFAULT \'pending\'', $sql);
        $this->assertNull($statements[0]['warning']);
    }
}
